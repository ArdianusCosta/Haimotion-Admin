  ...
  return (
    <div className="flex flex-col gap-6 pb-8 text-foreground">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-2">
        <h1 className="text-2xl font-bold text-primary">{t('Products & Services')}</h1>
...
`
fs.writeFileSync('components/finance/barang-jasa-page.tsx', code)
console.log('Done Barang')
